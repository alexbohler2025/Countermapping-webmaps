var config = {
    ...
    byline: 'Alex Bohler',
    para1: 'Due primarily to human activity, global temperatures have been rising the past 150 years, and will continue to rise in the future. This rise in temperature is also causing sea levels to rise. The IPCC currently forecasts that average sea level worldwide could rise anywhere from 1 foot to over 6 feet by 2100, depending on how much humanity curbs its carbon emissions, as well as how the oceans and ice caps respond to it. With roughly 10% of the population of the world living in coastal and low-lying areas, this rise in sea level will have major consequences. One area of coastal infrastructure that often gets little attention is historic buildings, sites, and landmarks. These locations are particularly at risk from sea level rise for a number of reasons.',
    ...
    chapters: [
        {
            ...
            description: 'Large amounts of water are stored in glaciers. Global rises in temperature cause these glaciers to melt, releasing their water into the oceans. Temperature rise also causes thermal expansion: decreasing the density of oceanic water, causing it to expand in volume. The combination of glacial melt and thermal expansion is what causes sea level rise.',
            location: {
                center: [90, -90],
                zoom: 1.5,
                pitch: 0,
        ...
        },
        {
            ...
            description: 'Global temperature rise the past 150 years has been almost entirely caused by humans. Burning of fossil fuels releases carbon dioxide. This atmospheric carbon dioxide makes the Earth less efficient at dispelling heat. As the graph above shows, global temperatures have risen significantly over the past century. Due to this, global mean sea level has already risen about 8 inches since 1920.',
            location: {
...
},
    {
        ...
        },
        {
            ...
            description: 'The original location of the port of Dutch Manhattan in the 17th century. The South Seaport was a commercial hub throughout the 18th and 19th centuries. It preserves much of the oldest architecture in Manhattan. Today, it is a picturesque area for restaurants, stores, and cultural sites. The Seaport was hit hard by Hurricane Sandy, flooding buildings and causing millions in damages.',
            location: {
        ...
        },
        {
            ...
            description: 'The ferry service here dates back to the mid 17th century. This historic district contains several 19th century buildings, including what is believed to be the oldest office building in NYC.',
            location: {
        ...
        },
        {
            ...
            description: 'Built in 1811 on Governors Island to defend the New York Harbor. It served as a prison during the American Civil War.',
            location: {
        ...
        },
        {
            ...
            description: 'Built between 1847 and 1861. Named after New Yorker Stephen Weed, who died at the Battle of Gettysburg. ',
            location: {
        ...
        },
        {
            ...
            description: 'So named because of the story that a cache of gold coins left by British soldiers was found in its walls in about 1860. The earliest part of the building dates to 1700.',
            location: {
        ...
        },
        {
            ...
            hidden: false,
            title: 'Conclusion',
            image: 'images/SandySeaportFlood.jpg',
            description: 'When Hurricane Sandy hit New York in 2012, it caused millions of dollars of damage to historic locations across the city (the image above is from the South Street Seaport). With future sea level rise, flooding that was once an extremely rare occurrence could become regular. Without adaptation, some locations could even be partially underwater daily by 2100. This map has shown the diverse range of sites in NYC that are at risk. Structures dating as far back as the 18th century, houses and shops, forts and warehouses, and even famous ruins could be affected. Enlarged floodplains and an increased frequency of extreme weather events, a topic not covered in this storymap, will enlarge the number of sites at risk even more. Despite the age of the city, New York conceals its past well. So much of its historic architecture has been lost over the years to demolition and reconstruction. That which remains is precious. It is my hope that plans for sea level resiliency in NYC will the unique value and vulnerabilities of these historic locations as they plan for the future.',
            location: {
                center: [-74.03755, 40.65505],
                zoom: 10.3,
                pitch: 0,
                bearing: 0
            },
